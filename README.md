...
```bash
# 从GitHub克隆项目
git clone git@github.com:ventibot9/geo.git
cd geo
...
- [x] 架构设计
- [x] 后端API基础（Node.js + Express + Prisma）
- [x] 前端管理界面（React + Vite + Ant Design）
- [x] 内容扫描器（Python + Puppeteer）
- [x] AI改写服务（FastAPI + 多模型支持）
- [x] 引用监控服务（Python + Selenium + APScheduler）
- [x] Docker部署
- [ ] 集成测试
- [ ] 生产部署
